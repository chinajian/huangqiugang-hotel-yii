...
<nav class="navbar navbar-default child-nav">
    <h5 class="nav pull-left">修改商品</h5>
...
<form class="form-horizontal" id="modForm">
    <input type="hidden" class="form-control input-sm" name="Goods[goods_id]" id="goods_id" value="<?php echo $goods['goods_id']?>">
    <div class="form-group">
        <label for="goods_name" class="col-sm-2 control-label">商品标题<span class="mandatory">*</span></label>
        <div class="col-sm-9">
            <input type="text" class="form-control input-sm" name="Goods[goods_name]" id="goods_name" value="<?php echo $goods['goods_name']?$goods['goods_name']:'';?>" placeholder="商品标题">
        </div>
    </div>
    <div class="form-group">
        <label for="goods_sn" class="col-sm-2 control-label">商品货号</label>
        <div class="col-sm-9">
            <input type="text" class="form-control input-sm" name="Goods[goods_sn]" id="goods_sn" value="<?php echo $goods['goods_sn']?$goods['goods_sn']:'';?>" placeholder="商品货号">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control input-sm" name="Goods[integral]" id="integral" value="<?php echo $goods['integral']?$goods['integral']:'';?>" placeholder="所需积分">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <ul class="upload" id="upload">
                <?php 
                    $i = 0;
                    foreach($goods['album_img'] as $k => $v){
                ?>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 iCheck">
            <label class="radio-inline">
                <input type="radio" name="Goods[is_new]" value="1" <?php if($goods['is_new'] === '1'){?>checked<?php }?>> 否
            </label>
            <label class="radio-inline">
                <input type="radio" name="Goods[is_new]" value="2" <?php if($goods['is_new'] === '2'){?>checked<?php }?>> 是
            </label>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-9 iCheck">
            <label class="radio-inline">
                <input type="radio" name="Goods[is_best]" value="1" <?php if($goods['is_best'] === '1'){?>checked<?php }?>> 否
            </label>
            <label class="radio-inline">
                <input type="radio" name="Goods[is_best]" value="2" <?php if($goods['is_best'] === '2'){?>checked<?php }?>> 是
            </label>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-9 iCheck">
            <label class="radio-inline">
                <input type="radio" name="Goods[is_hot]" value="1" <?php if($goods['is_hot'] === '1'){?>checked<?php }?>> 否
            </label>
            <label class="radio-inline">
                <input type="radio" name="Goods[is_hot]" value="2" <?php if($goods['is_hot'] === '2'){?>checked<?php }?>> 是
            </label>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control input-sm" name="Goods[keywords]" id="keywords" value="<?php echo $goods['keywords']?$goods['keywords']:'';?>" placeholder="关键字">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control input-sm" name="Goods[sort]" id="sort" value="<?php echo $goods['sort']?$goods['sort']:'';?>" placeholder="排序">
        </div>
    </div>
    <div class="form-group">
        <label for="goods_brief" class="col-sm-2 control-label">描述</label>
        <div class="col-sm-9">
            <textarea class="form-control" name="Goods[goods_brief]" id="goods_brief" rows="2"><?php echo $goods['goods_brief']?></textarea>
        </div>
    </div>
    <div class="form-group">
        <label for="goods_desc" class="col-sm-2 control-label">详细说明<span class="mandatory">*</span></label>
        <div class="col-sm-9">
            <script class="editor" id="goods_desc" name="Goods[goods_desc]" type="text/plain" style="height: 150px;"><?php echo $goods['goods_desc']?></script>
        </div>
    </div>
    <div class="form-group">
...
<script type="text/javascript">
    ...
    $("#add").click(function(){
        ...
        /*相册图片，循环出一个input列表<<<*/
        jajax("<?php echo Url::to(['goods/mod-goods'])?>", $('#modForm').serialize());
    })
