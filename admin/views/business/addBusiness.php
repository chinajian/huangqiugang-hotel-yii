...
<nav class="navbar navbar-default child-nav">
    <h5 class="nav pull-left">添加商务</h5>
...
<form class="form-horizontal" id="addForm">
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control input-sm" name="Business[title]" id="title" placeholder="商务标题">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-9">
            ...
            <input type="hidden" name="Business[thumb]" id="thumb">
        </div>
    </div>
    <div class="form-group">
        <label for="area" class="col-sm-2 control-label">面积</label>
        <div class="col-sm-9">
            <input type="text" class="form-control input-sm" name="Business[area]" id="area" placeholder="面积">
        </div>
    </div>
    <div class="form-group">
        <label for="capacity" class="col-sm-2 control-label">容纳人数</label>
        <div class="col-sm-9">
            <input type="text" class="form-control input-sm" name="Business[capacity]" id="capacity" placeholder="容纳人数">
        </div>
    </div>
    <div class="form-group">
        <label for="shape" class="col-sm-2 control-label">形状</label>
        <div class="col-sm-9">
            <input type="text" class="form-control input-sm" name="Business[shape]" id="shape" placeholder="形状">
        </div>
    </div>
    <div class="form-group">
        <label for="copyfrom" class="col-sm-2 control-label">来源</label>
        <div class="col-sm-9">
            <input type="text" class="form-control input-sm" name="Business[copyfrom]" id="copyfrom" placeholder="来源">
        </div>
    </div>
    <div class="form-group">
        <label for="keywords" class="col-sm-2 control-label">关键字</label>
        <div class="col-sm-9">
            <input type="text" class="form-control input-sm" name="Business[keywords]" id="keywords" placeholder="关键字">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9 iCheck">
            <label class="radio-inline">
                <input type="radio" name="Business[business_type]" value="0"> 普通
            </label>
            <label class="radio-inline">
                <input type="radio" name="Business[business_type]" value="1"> 置顶
            </label>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-9 iCheck">
            <label class="radio-inline">
                <input type="radio" name="Business[status]" value="0"> 不显示
            </label>
            <label class="radio-inline">
                <input type="radio" name="Business[status]" value="1"> 显示
            </label>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <input type="text" class="form-control input-sm" name="Business[link]" id="link" placeholder="外部链接">
        </div>
    </div>
    <div class="form-group">
        <label for="sort" class="col-sm-2 control-label">排序</label>
        <div class="col-sm-9">
            <input type="text" class="form-control input-sm" name="Business[sort]" id="sort" placeholder="排序">
        </div>
    </div>
    <div class="form-group">
        <label for="add_time" class="col-sm-2 control-label">添加时间</label>
        <div class="col-sm-9">
            <input type="text" class="form-control input-sm form_datetime" name="Business[add_time]" id="add_time" placeholder="添加时间" readonly>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-9">
            <textarea class="form-control" name="Business[description]" id="description" rows="2"></textarea>
        </div>
    </div>
    <div class="form-group">
        <label for="content" class="col-sm-2 control-label">内容</label>
        <div class="col-sm-9">
            <script class="editor" id="content" name="Business[content]" type="text/plain" style="height: 250px;"></script>
        </div>
    </div>
    <div class="form-group">
...
<script type="text/javascript">
    ...
    /*添加*/
    $("#add").click(function(){
        jajax("<?php echo Url::to(['business/add-business'])?>", $('#addForm').serialize());
    })
